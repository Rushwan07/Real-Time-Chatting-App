  ...
  return (
    <div>
      {friends.map((friend, index) => (
        <Link key={index} to={`/MessegeArea/${index}`}>
          <div className="chat w-full p-3 flex justify-between items-center cursor-pointer mt-2">
            <div className="flex gap-2 w-[80%]">
              ...
              <div className="">
                ...
                <h5 className="truncate w-[170px] md:w-[65vw] lg:w-[170px]">
                  ...
                  minima voluptas alias dolor! Ab veritatis similique fuga
                  nostrum aspernatur quas atque repudiandae minima nemo tempore!
                </h5>
              </div>
            </div>
