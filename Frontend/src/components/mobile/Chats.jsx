  ...
  return (
    <div>
      {friends.map((friend, index) => {
        ...
        return (
          // <Link to={"MessegeArea/" + friend._id}>
          <div
            ...
            onClick={() => {
              ...
              navigate("MessegeArea/" + friend?._id);
            }}
          >
            <div
            ...
            <div className="flex flex-col justify-center items-center w-[20%] gap-1">
              {isAlreadyFriend ? (
                ...
                <button
                  ...
                  className="bg-[#08CB00] text-white text-[1.2rem] font-bold text-sm px-4 py-1 rounded active:scale-95 transition"
                >
                  Add
                </button>
              )}
